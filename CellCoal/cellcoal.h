...
static void 	MakeDoublets (long int *seed);
...
static double	*periodGrowth, growthRate, sequencingError, ADOrate, allelicImbalance, genotypingError, meanAmplificationError, varAmplificationError, doubletRate;
